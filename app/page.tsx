...
import { Wallet, Gamepad2, BookOpen, Trophy, BarChart3, Star, ArrowRight, AlignHorizontalDistributeCenter } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#0A192F] to-[#0A6C74] text-[#F5F7FA]">
      {/* Animated Background */}
      ...
      <motion.header
        ...
        className="sticky topからは0 z-50 w-full bg-[#0A192F]/70 backdrop-blur-md border-b border-[#0A6C74]/50 shadow-sm"
      >
        <div className="container flex h-16 items-center">
          <div className="mr-4 flex">
            <Link href="/" className="mr-6 flex items-center space-x-2">
              ...
              <motion.span
                className="font-bold text-2xl bg-clip-text text-transparent bg-gradient-to-r from-[#FFD700] to-[#0A6C74]"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                ...
                <Link key={idx} href={`/${item}`}>
                  <motion.div whileHover="hover" variants={buttonHover}>
                    <Button
                      ...
                      className={`${
                        item === "register"
                          ? "bg-gradient-to-r from-[#FFD700] to-[#0A6C74] text-[#0A192F] hover:opacity-90"
                          : "text-[#F5F7FA] hover:bg-[#0A6C74]/50 hover:text-[#FFD700]"
      ...
      <main className="flex-1 relative">
        ...
        <section ref={heroRef} className="w-full py-16 md:py-24 lg:py-32 relative overflow-hidden">
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-[#0A6C74]/20 to-[#FFD700]/20"
            style={{ y: parallaxY }}
          />
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                <div className="space-y-4">
                  <motion.h1
                    className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-[#F5F7FA] to-[#FFD700]"
                  ...
                  <motion.p
                    className="max-w-[600px] text-[#6B7280] md:text-xl"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 0.5, duration: 0.6 }}
                  >
                    FinZ transforms financial literacy into an exciting adventure with games, simulations, and challenges
                    crafted for Gen Z.
                  </motion.p>
                </div>
              ...
              >
                <div className="relative w-full max-w-[400px] h-[300px] bg-[#0A192F]/50 backdrop-blur-md rounded-xl shadow-xl overflow-hidden">
                  <motion.div
                    className="absolute inset-0 flex items-center justify-center"
                    animate={{ rotateY: [0, 360] }}
                    transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                  >
                    <svg className="h-32 w-32 text-[#FFD700]" viewBox="0 0 100 100">
        ...
        {/* Features Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#0A192F]/90">
          <div className="container px-4 md:px-6">
            <motion.div
              ...
              variants={fadeIn}
            >
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-[#F5F7FA]">
                Why FinZ Rocks
              </h2>
              ...
              {[
                {
                  ...
                  icon: <AlignHorizontalDistributeCenter className="h-8 w-8 text-[#FFD700]" />,
                },
                {
                  title: "Mini-Games",
                  desc: "Fun with purpose",
                  content: "Play addictive games that teach budgeting, taxes, and more.",
                  icon: <Gamepad2 className="h-8 w-8 text-[#FFD700]" />,
                },
                {
                ...
                },
                {
                  ...
                  icon: <BarChart3 className="h-8 w-8 text-[#FFD700]" />,
                },
                {
                  title: "Virtual Wallet",
                  desc: "Manage money",
                  content: "Practice saving, spending, and investing with in-game currency.",
                  icon: <Wallet className="h-8 w-8 text-[#FFD700]" />,
                },
                {
                  title: "Leaderboards",
                  desc: "Compete & win",
                ...
                <motion.div key={index} variants={fadeIn} whileHover="hover" variants={cardHover}>
                  <Card className="bg-[#0A192F]/70 backdrop-blur-md border-[#0A6C74]/50 shadow-xl rounded-xl overflow-hidden">
                    <CardHeader>
                      <div className="flex items-center gap-3">
                        {feature.icon}
                        <CardTitle className="text-[#F5F7FA]">{feature.title}</CardTitle>
                      </div>
                      <CardDescription className="text-[#6B7280]">{feature.desc}</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-[#6B7280]">{feature.content}</p>
                    </CardContent>
                  </Card>
                </motion.div>
              ))}
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-[#0A6C74]/20 to-[#0A192F]">
          <div className="container px-4 md:px-6">
            <motion.div
              className="flex flex-col items-center justify-center space-y-4 text-center"
              initial="hidden"
            ...
            >
              ...
              <p className="max-w-[900px] text-[#6B7280] md:text-xl/relaxed">
                Hear from Gen Z learners loving FinZ!
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {[
                ...
                <motion.div key={index} variants={fadeIn} whileHover={{ y: -5 }}>
                  <Card className="bg-[#0A192F]/70 backdrop-blur-md border-[#0A6C74]/50 shadow-xl rounded-xl">
                    <CardContent className="pt-6">
                      ...
                      <p className="mt-4 font-medium text-[#F5F7FA]">{testimonial.name}</p>
                    </CardContent>
                  </Card>
                </motion.div>
              ))}
        ...
        {/* Stats Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#0A192F]">
          <div className="container px-4 md:px-6">
            <motion.div
        ...
        {/* CTA Banner */}
        <section className="w-full py-12 md:py-24 bg-gradient-to-r from-[#FFD700] to-[#0A6C74]">
          <div className="container px-4 md:px-6 text-center">
            ...
            >
              ...
              <p className="max-w-[600px] mx-auto text-[#0A192F]/80 md:text-xl">
              ...
              <Link href="/register">
                <motion.div whileHover="hover" variants={buttonHover}>
                  <Button
                    size="lg"
                    className="bg-[#0A192F] text-[#FFD700] hover:bg-[#0A192F]/90 rounded-full animate-pulse-subtle"
                  >
      ...
      {/* Footer */}
      <footer className="border-t py-6 bg-[#0A192F]/90 text-[#F5F7FA]">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          <p className="text-center text-sm leading-loose text-[#6B7280]">
            © 2025 FinZ. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <Link href="/terms" className="text-sm text-[#6B7280] hover:text-[#FFD700] transition-colors">
              Terms
            </Link>
            <Link href="/privacy" className="text-sm text-[#6B7280] hover:text-[#FFD700] transition-colors">
              Privacy
            </Link>
            <a href="https://twitter.com/FinZ" className="text-[#6B7280] hover:text-[#FFD700]">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://discord.com/FinZ" className="text-[#6B7280] hover:text-[#FFD700]">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        <Link href="/register">
          <Button className="bg-[#FFD700] text-[#0A192F] hover:bg-[#FFD700]/80 rounded-full p-4 shadow-lg animate-pulse-subtle">
            Join Now
          </Button>
        </Link>
      </motion.div>
